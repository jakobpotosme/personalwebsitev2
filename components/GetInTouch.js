...
function GetInTouch() {
  return (
    <div className="relative flex py-32 flex-col justify-center items-center gap-x-6 gap-y-6 xs:pl-44 ">
      ...
      <p className=" w-3/4 pb-12 text-center">
      ...
      <a
        ...
        className="border border-[#00A789] hover:bg-[#007583]/30  pt-4 rounded-lg p-4"
      >
        Contact Me
      </a>
      ...
      {/* <a href={`https://umami-production-2ff2.up.railway.app/share/vwOxsDne/Jakob's%20Site`} 
        className=' hover:text-[#00A789] pt-10 -mb-5'> Analytics</a> */}
    </div>
  );
}

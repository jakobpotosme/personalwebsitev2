...
function About() {
  ...
  return (
    <>
      <div className="xs:hidden md:block flex flex-col gap-y-2 justify-left items-left  py-32 min-h-[80vh] md:pb-40 max-w-[90%] mx-auto ">
        ...
        <div className="flex flex-row justify-between pb-10">
          <div className="w-1/2 flex flex-col gap-y-4">
            <h3>
              Hello! My name is Jakob. My interests in programming stems from my
              passion for sneakers. I was amazed by just how powerful software
              can be.{" "}
            </h3>
            <h3>
              Now, I have had the pleasure of working on numerous projects with
              local companies and online communties, turning ideas into a
              reality by designing and creating applications from start to
              finish providing an excellent user experience.{" "}
            </h3>
            <h3>
              I am currently seeking opportunities that will allow me to use the
              skills that I have learned from both university and personal
              projects, in order to make a difference as a developer.
            </h3>
          </div>
        ...
        <div className=" ">
          <h1 className="flex-shrink text-2xl font-semibold pb-10">
            {" "}
...
, first frontend framework that I learned, great if you are making an authenticated website."
      ...
      <div className="xs:grid md:hidden lg:hidden xl:hidden xxl:hidden hidden grid-cols-1  max-w-[90%] mx-auto ">
        {/* Left Col */}
        <div className="flex flex-col gap-y-4 mx-auto text-center">
          <span className=" text-lg border-b font-medium">About Me</span>
          <p className="text-sm   ">
            Hello! My name is Jakob. My interests in programming stems from my
            passion for sneakers. I was amazed by just how powerful software can
            be.
          </p>

          <p className="text-sm  ">
            Now, I have had the pleasure of working on numerous projects with
            local companies and online communties, turning ideas into a reality
            by designing and creating applications from start to finish
        ...
        <h1 className="flex-shrink text-base text-center font-medium pt-10 pb-4">
          Current Favorite Tech Stack
        </h1>
        <div className="grid grid-cols-3 gap-x-10 gap-y-4 mx-auto">
          <Tooltip
            title="Next.js
, currently my go-to framework because of the static generation, dynamic paths, and built-in api."
            position="bottom"
          ...
          >
            {/* <Image src={nextJsIcon} alt='nextjs' width={40} height={40} /> */}
            <SiNextdotjs size={25} className=" hover:fill-[#00A789]" />
          </Tooltip>
...
, first frontend framework that I learned, great if you are making an authenticated website."
          ...
          >
            {/* <Image src={reactIcon} alt='react'  width={40} height={40}/> */}
            <SiReact size={25} className=" hover:fill-[#00A789]" />
          </Tooltip>
          <Tooltip
            title="Tailwind CSS ,
                    easy styling which saving me from a bunch of headaches. Great extension as well."
          ...
          >
            {/* <Image src={tailwindIcon} alt='tailwind' width={40} height={40} /> */}
            <SiTailwindcss size={25} className=" hover:fill-[#00A789]" />
          </Tooltip>
          ...
          <Tooltip
            ...
            trigger="mouseenter "
          >
            <SiSupabase size={25} className=" hover:fill-[#00A789]" />
            {/* <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="40" height="40" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="white" d="M21.362 9.354H12V.396a.396.396 0 0 0-.716-.233L2.203 12.25-.401.562a1.04 1.04 0 0 0 .836 1.659H12v8.959a.396.396 0 0 0 .716.233l9.081-12.261l.401-.562a1.04 1.04 0 0 0-.836-1.66z"/></svg> */}
          </Tooltip>
          ...
          <Tooltip
            ...
            trigger="mouseenter "
          >
            <SiJavascript size={25} className=" hover:fill-[#00A789]" />
            {/* <Image src={jsIcon} alt='js'width={40} height={40} /> */}
          </Tooltip>
        </div>
      </div>
